...
function buildBody(url, results, attempt, addHeader) {
    return `${addHeader && '# ![Helix](https://raw.githubusercontent.com/auniverseaway/helix-actions/main/helix-logo.svg) Helix Actions' }
